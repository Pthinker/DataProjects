...
from crunchbase_scraper.items import FinancialOrgItem
import simplejson
import os
...
class FinancialOrgSpider(BaseSpider):
    ...
    start_urls = []
    for c in clist:
        start_urls.append("http://www.crunchbase.com/financial-organizations?c=%s" % c)
    ...
    def parse_json(self, response, crunch_id):
        fpath = "crunchbase_scraper/financial_json/%s.json" % crunch_id
